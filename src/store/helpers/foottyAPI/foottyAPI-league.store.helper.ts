...
const getLeagueDetails = (getLeagueDetailsResponse: GetLeagueDetailsResponse): ObjectizedLeagueDetails => {
  const leagueDetail: LeagueDetails = getLeagueDetailsResponse.leagues[0];

  const leagueDetails: ObjectizedLeagueDetails = {
    leagueId: leagueDetail.idLeague,
...
const foottyAPILeagueStoreHelper = {
  getLeagueDetails,
  getAllTeamsInLeague,
  getLeagueSeasons,
  getNextEvents,
...
export default foottyAPILeagueStoreHelper;
